...
import com.homw.gateway.api.keda.SocketTool;
import com.homw.gateway.api.keda.SocketToolThreadSafe;
...
public class SocketToolTest {
	...
	public static void main(String[] args) throws Exception {
		...
		new Thread("Thread-Server-Acceptor") {
			public void run() {
				try {
					final ServerSocket server = new ServerSocket(server_port, concurrency);
					if (debug_enabled) {
